...
builder.objectType(FieldBehaviorCommentsMessage$Ref, {
  ...
  isTypeOf: (source) => {
    return source instanceof FieldBehaviorCommentsMessage;
  },
  extensions: {
    protobufMessage: {
...
builder.objectType(FieldBehaviorCommentsMessagePost$Ref, {
  ...
  isTypeOf: (source) => {
    return source instanceof FieldBehaviorCommentsMessage_Post;
  },
  extensions: {
    protobufMessage: {
      fullName:
...
export function FieldBehaviorCommentsMessageInput$toProto(
  ...
  return new FieldBehaviorCommentsMessage({
...
export function FieldBehaviorCommentsMessagePostInput$toProto(
  ...
  return new FieldBehaviorCommentsMessage_Post({
