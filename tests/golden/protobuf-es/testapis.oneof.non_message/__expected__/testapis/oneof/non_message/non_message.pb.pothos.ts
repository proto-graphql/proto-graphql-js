// @generated by protoc-gen-pothos v0.7.0 with parameter "import_prefix=@proto-graphql/e2e-testapis-protobuf-es-v2/lib/,pothos_builder_path=../builder,protobuf_lib=protobuf-es,ignore_non_message_oneof_fields"
...
builder.objectType(MessageMember$Ref, {
  ...
  isTypeOf: (source) => {
    return isMessage(source, MessageMemberSchema);
  },
  extensions: {
    protobufMessage: {
