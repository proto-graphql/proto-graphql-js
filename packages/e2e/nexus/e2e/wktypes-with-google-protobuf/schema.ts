...
import * as types1 from "../__generated__/google-protobuf/testapis/wktypes/well_known_types_pb_nexus";
...
export const schema = makeTestSchema({ rootDir: __dirname, types: [dateTime, types1, testQuery] });
