...
import type { $$testapis$node$lib$$testapis$primitives$testapis$primitives$Message, $$testapis$node$lib$$testapis$primitives$testapis$primitives$Primitives } from "./../../__generated__/nexus/protobufjs/testapis/primitives/primitives_pb_nexus"
...
export interface NexusGenObjects {
  Message: $$testapis$node$lib$$testapis$primitives$testapis$primitives$Message;
  Primitives: $$testapis$node$lib$$testapis$primitives$testapis$primitives$Primitives;
  Query: {};
}
