...
import type { $$testapis$node$lib$$testapis$nested$testapis$nested$ParentMessage, $$testapis$node$lib$$testapis$nested$testapis$nested$ParentMessageNestedMessage } from "./../../__generated__/nexus/protobufjs/testapis/nested/nested_pb_nexus"
