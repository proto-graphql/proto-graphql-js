...
import type { $$testapis$node_native$lib$$testapis$multipkgs$subpkg1$types_pb$SubpkgMessage } from "./../../__generated__/nexus/google-protobuf/testapis/multipkgs/subpkg1/types_pb_nexus"
import type { $$testapis$node_native$lib$$testapis$multipkgs$subpkg2$types_pb$MessageWithSubpkg } from "./../../__generated__/nexus/google-protobuf/testapis/multipkgs/subpkg2/types_pb_nexus"
...
export interface NexusGenObjects {
  MessageWithSubpkg: $$testapis$node_native$lib$$testapis$multipkgs$subpkg2$types_pb$MessageWithSubpkg;
  Query: {};
  SubpkgMessage: $$testapis$node_native$lib$$testapis$multipkgs$subpkg1$types_pb$SubpkgMessage;
}
