...
goog.exportSymbol("proto.graphql.GraphqlInputObjectTypeOptions", null, global);
...
goog.exportSymbol("proto.graphql.inputType", null, global);
 ...
 * @constructor
 */
proto.graphql.GraphqlInputObjectTypeOptions = function (opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.graphql.GraphqlInputObjectTypeOptions, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.graphql.GraphqlInputObjectTypeOptions.displayName = "proto.graphql.GraphqlInputObjectTypeOptions";
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.graphql.GraphqlInputObjectTypeOptions.prototype.toObject = function (opt_includeInstance) {
    return proto.graphql.GraphqlInputObjectTypeOptions.toObject(opt_includeInstance, this);
  };
   ...
   *     the JSPB instance for transitional soy proto support:
   *     http://goto/soy-param-migration
   * @param {!proto.graphql.GraphqlInputObjectTypeOptions} msg The msg instance to transform.
   * @return {!Object}
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.graphql.GraphqlInputObjectTypeOptions.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ignore: jspb.Message.getBooleanFieldWithDefault(msg, 1, false),
      };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.graphql.GraphqlInputObjectTypeOptions}
 */
proto.graphql.GraphqlInputObjectTypeOptions.deserializeBinary = function (bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.graphql.GraphqlInputObjectTypeOptions();
  return proto.graphql.GraphqlInputObjectTypeOptions.deserializeBinaryFromReader(msg, reader);
};

/**
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.graphql.GraphqlInputObjectTypeOptions} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.graphql.GraphqlInputObjectTypeOptions}
 */
proto.graphql.GraphqlInputObjectTypeOptions.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.graphql.GraphqlInputObjectTypeOptions.prototype.serializeBinary = function () {
  var writer = new jspb.BinaryWriter();
  proto.graphql.GraphqlInputObjectTypeOptions.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.graphql.GraphqlInputObjectTypeOptions} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.graphql.GraphqlInputObjectTypeOptions.serializeBinaryToWriter = function (message, writer) {
  var f = undefined;
  f = message.getIgnore();
  if (f) {
    writer.writeBool(1, f);
 ...
 * @return {boolean}
 */
proto.graphql.GraphqlInputObjectTypeOptions.prototype.getIgnore = function () {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 1, false));
};

/**
 * @param {boolean} value
 * @return {!proto.graphql.GraphqlInputObjectTypeOptions} returns this
 */
proto.graphql.GraphqlInputObjectTypeOptions.prototype.setIgnore = function (value) {
  return jspb.Message.setProto3BooleanField(this, 1, value);
};
...
proto.graphql.schema = new jspb.ExtensionFieldInfo(
  ...
  /** @type {?function((boolean|undefined),!jspb.Message=): !Object} */ (proto.graphql.GraphqlSchemaOptions.toObject),
  0
);
...
proto.graphql.objectType = new jspb.ExtensionFieldInfo(
  ...
  /** @type {?function((boolean|undefined),!jspb.Message=): !Object} */ (proto.graphql.GraphqlObjectTypeOptions
    .toObject),
  0
);
...
/**
 * A tuple of {field number, class constructor} for the extension
 * field named `inputType`.
 * @type {!jspb.ExtensionFieldInfo<!proto.graphql.GraphqlInputObjectTypeOptions>}
 */
proto.graphql.inputType = new jspb.ExtensionFieldInfo(
  2057,
  { inputType: 0 },
  proto.graphql.GraphqlInputObjectTypeOptions,
  /** @type {?function((boolean|undefined),!jspb.Message=): !Object} */ (proto.graphql.GraphqlInputObjectTypeOptions
    .toObject),
  0
);

google_protobuf_descriptor_pb.MessageOptions.extensionsBinary[2057] = new jspb.ExtensionFieldBinaryInfo(
  proto.graphql.inputType,
  jspb.BinaryReader.prototype.readMessage,
  jspb.BinaryWriter.prototype.writeMessage,
  proto.graphql.GraphqlInputObjectTypeOptions.serializeBinaryToWriter,
  proto.graphql.GraphqlInputObjectTypeOptions.deserializeBinaryFromReader,
  false
);
// This registers the extension field with the extended class, so that
// toObject() will function correctly.
google_protobuf_descriptor_pb.MessageOptions.extensions[2057] = proto.graphql.inputType;
...
proto.graphql.field = new jspb.ExtensionFieldInfo(
  ...
  /** @type {?function((boolean|undefined),!jspb.Message=): !Object} */ (proto.graphql.GraphqlFieldOptions.toObject),
  0
);
...
proto.graphql.oneof = new jspb.ExtensionFieldInfo(
  ...
  /** @type {?function((boolean|undefined),!jspb.Message=): !Object} */ (proto.graphql.GraphqlOneofOptions.toObject),
  0
);
...
proto.graphql.enumType = new jspb.ExtensionFieldInfo(
  ...
  /** @type {?function((boolean|undefined),!jspb.Message=): !Object} */ (proto.graphql.GraphqlEnumOptions.toObject),
  0
);
...
proto.graphql.enumValue = new jspb.ExtensionFieldInfo(
  ...
  /** @type {?function((boolean|undefined),!jspb.Message=): !Object} */ (proto.graphql.GraphqlEnumValueOptions
    .toObject),
  0
);
