...
export class GraphqlSchemaOptions extends Message<GraphqlSchemaOptions> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    {
      no: 2,
      name: "ignore_requests",
      kind: "scalar",
      T: 8 /* ScalarType.BOOL */,
    },
    {
      no: 3,
      name: "ignore_responses",
      kind: "scalar",
      T: 8 /* ScalarType.BOOL */,
    },
  ...
  static equals(
    a: GraphqlSchemaOptions | PlainMessage<GraphqlSchemaOptions> | undefined,
    b: GraphqlSchemaOptions | PlainMessage<GraphqlSchemaOptions> | undefined,
  ): boolean {
...
export class GraphqlObjectTypeOptions extends Message<GraphqlObjectTypeOptions> {
  ...
  static equals(
    a:
      | GraphqlObjectTypeOptions
      | PlainMessage<GraphqlObjectTypeOptions>
      | undefined,
    b:
      | GraphqlObjectTypeOptions
      | PlainMessage<GraphqlObjectTypeOptions>
...
export class GraphqlInputTypeOptions extends Message<GraphqlInputTypeOptions> {
  ...
  static equals(
    a:
      | GraphqlInputTypeOptions
      | PlainMessage<GraphqlInputTypeOptions>
      | undefined,
    b:
      | GraphqlInputTypeOptions
      | PlainMessage<GraphqlInputTypeOptions>
...
export class GraphqlFieldOptions extends Message<GraphqlFieldOptions> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    {
      no: 11,
      name: "output_nullability",
      kind: "enum",
      T: proto3.getEnumType(Nullability),
    },
    {
      no: 12,
      name: "input_nullability",
      kind: "enum",
      T: proto3.getEnumType(Nullability),
    },
    {
      no: 13,
      name: "partial_input_nullability",
      kind: "enum",
      T: proto3.getEnumType(Nullability),
    },
  ]);
  ...
  static equals(
    a: GraphqlFieldOptions | PlainMessage<GraphqlFieldOptions> | undefined,
    b: GraphqlFieldOptions | PlainMessage<GraphqlFieldOptions> | undefined,
  ): boolean {
...
export class GraphqlOneofOptions extends Message<GraphqlOneofOptions> {
  ...
  static equals(
    a: GraphqlOneofOptions | PlainMessage<GraphqlOneofOptions> | undefined,
    b: GraphqlOneofOptions | PlainMessage<GraphqlOneofOptions> | undefined,
  ): boolean {
...
export class GraphqlEnumOptions extends Message<GraphqlEnumOptions> {
  ...
  static equals(
    a: GraphqlEnumOptions | PlainMessage<GraphqlEnumOptions> | undefined,
    b: GraphqlEnumOptions | PlainMessage<GraphqlEnumOptions> | undefined,
  ): boolean {
...
export class GraphqlEnumValueOptions extends Message<GraphqlEnumValueOptions> {
  ...
  static equals(
    a:
      | GraphqlEnumValueOptions
      | PlainMessage<GraphqlEnumValueOptions>
      | undefined,
    b:
      | GraphqlEnumValueOptions
      | PlainMessage<GraphqlEnumValueOptions>
 ...
 */
export const object_type = proto3.makeExtension<
  MessageOptions,
  GraphqlObjectTypeOptions
>("graphql.object_type", MessageOptions, () => ({
  no: 2056,
  kind: "message",
  T: GraphqlObjectTypeOptions,
}));

/**
 * @generated from extension: graphql.GraphqlInputTypeOptions input_type = 2057;
 */
export const input_type = proto3.makeExtension<
  MessageOptions,
  GraphqlInputTypeOptions
>("graphql.input_type", MessageOptions, () => ({
  no: 2057,
  kind: "message",
  T: GraphqlInputTypeOptions,
}));
 ...
 */
export const enum_value = proto3.makeExtension<
  EnumValueOptions,
  GraphqlEnumValueOptions
>("graphql.enum_value", EnumValueOptions, () => ({
  no: 2056,
  kind: "message",
  T: GraphqlEnumValueOptions,
}));
