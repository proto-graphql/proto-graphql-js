...
goog.exportSymbol('proto.graphql.GraphqlInputTypeOptions', null, global);
 ...
 * @constructor
 */
proto.graphql.GraphqlInputTypeOptions = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.graphql.GraphqlInputTypeOptions, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.graphql.GraphqlInputTypeOptions.displayName = 'proto.graphql.GraphqlInputTypeOptions';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.graphql.GraphqlInputTypeOptions.prototype.toObject = function(opt_includeInstance) {
  return proto.graphql.GraphqlInputTypeOptions.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.graphql.GraphqlInputTypeOptions} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.graphql.GraphqlInputTypeOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    noPartial: jspb.Message.getBooleanFieldWithDefault(msg, 1, false),
    ignore: jspb.Message.getBooleanFieldWithDefault(msg, 2, false)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.graphql.GraphqlInputTypeOptions}
 */
proto.graphql.GraphqlInputTypeOptions.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.graphql.GraphqlInputTypeOptions;
  return proto.graphql.GraphqlInputTypeOptions.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.graphql.GraphqlInputTypeOptions} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.graphql.GraphqlInputTypeOptions}
 */
proto.graphql.GraphqlInputTypeOptions.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.graphql.GraphqlInputTypeOptions.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.graphql.GraphqlInputTypeOptions.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.graphql.GraphqlInputTypeOptions} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.graphql.GraphqlInputTypeOptions.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getNoPartial();
  if (f) {
    writer.writeBool(
      1,
      f
...
/**
 * optional bool no_partial = 1;
 * @return {boolean}
 */
proto.graphql.GraphqlInputTypeOptions.prototype.getNoPartial = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 1, false));
};
...
/**
 * @param {boolean} value
 * @return {!proto.graphql.GraphqlInputTypeOptions} returns this
 */
proto.graphql.GraphqlInputTypeOptions.prototype.setNoPartial = function(value) {
  return jspb.Message.setProto3BooleanField(this, 1, value);
};
 ...
 * @return {boolean}
 */
proto.graphql.GraphqlInputTypeOptions.prototype.getIgnore = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 2, false));
};
 ...
 * @return {!proto.graphql.GraphqlInputTypeOptions} returns this
 */
proto.graphql.GraphqlInputTypeOptions.prototype.setIgnore = function(value) {
  return jspb.Message.setProto3BooleanField(this, 2, value);
};
...
proto.graphql.GraphqlFieldOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    id: jspb.Message.getBooleanFieldWithDefault(msg, 4, false),
 ...
 * @return {boolean}
 */
proto.graphql.GraphqlFieldOptions.prototype.getId = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 4, false));
};
 ...
 * @return {!proto.graphql.GraphqlFieldOptions} returns this
 */
proto.graphql.GraphqlFieldOptions.prototype.setId = function(value) {
  return jspb.Message.setProto3BooleanField(this, 4, value);
};
 ...
 * @type {!jspb.ExtensionFieldInfo<!proto.graphql.GraphqlInputTypeOptions>}
 */
proto.graphql.inputType = new jspb.ExtensionFieldInfo(
    2057,
    {inputType: 0},
    proto.graphql.GraphqlInputTypeOptions,
     /** @type {?function((boolean|undefined),!jspb.Message=): !Object} */ (
         proto.graphql.GraphqlInputTypeOptions.toObject),
    0);
...
google_protobuf_descriptor_pb.MessageOptions.extensionsBinary[2057] = new jspb.ExtensionFieldBinaryInfo(
    ...
    jspb.BinaryReader.prototype.readMessage,
    jspb.BinaryWriter.prototype.writeMessage,
    proto.graphql.GraphqlInputTypeOptions.serializeBinaryToWriter,
    proto.graphql.GraphqlInputTypeOptions.deserializeBinaryFromReader,
    false);
// This registers the extension field with the extended class, so that
// toObject() will function correctly.
