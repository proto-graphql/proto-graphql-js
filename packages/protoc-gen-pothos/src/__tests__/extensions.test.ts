...
describe("no_partial", () => {
  it("generates pothos DSLs with partial inputs", async () => {
    ...
    snapshotGeneratedFiles(resp, ["extensions/no_partial/no_partial.pb.pothos.ts"]);
  });
});
...
describe("field_nullability", () => {
  it("generates pothos DSLs with partial inputs", async () => {
    ...
    snapshotGeneratedFiles(resp, ["extensions/field_nullability/nullability.pb.pothos.ts"]);
  });
});
