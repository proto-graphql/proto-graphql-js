...
import * as $$testapis$node$lib$testapis$hello from "@testapis/node/lib/testapis/hello";
export type $$testapis$node$lib$testapis$hello$testapis$hello$Hello = $$testapis$node$lib$testapis$hello.testapis.hello.IHello;
export type $$testapis$node$lib$testapis$hello$testapis$hello$Primitives = $$testapis$node$lib$testapis$hello.testapis.hello.IPrimitives;
export const Hello = objectType({
    ...
    sourceType: { module: __filename, export: "$$testapis$node$lib$testapis$hello$testapis$hello$Hello" }
});
export const Primitives = objectType({
    ...
    sourceType: { module: __filename, export: "$$testapis$node$lib$testapis$hello$testapis$hello$Primitives" }
});
