...
$root.testapis = (function() {
    ...
    testapis.wktypes = (function() {
        ...
        wktypes.Message = (function() {
             ...
             * @implements IMessage
             * @constructor
             * @param {testapis.wktypes.IMessage=} [properties] Properties to set
             */
             ...
             * @memberof testapis.wktypes.Message
             * @instance
             */
             ...
             * @static
             * @param {testapis.wktypes.IMessage=} [properties] Properties to set
             * @returns {testapis.wktypes.Message} Message instance
             */
            ...
            /**
             * Encodes the specified Message message. Does not implicitly {@link testapis.wktypes.Message.verify|verify} messages.
             * @function encode
             * @memberof testapis.wktypes.Message
             * @static
             * @param {testapis.wktypes.IMessage} message Message message or plain object to encode
            ...
            /**
             * Encodes the specified Message message, length delimited. Does not implicitly {@link testapis.wktypes.Message.verify|verify} messages.
             ...
             * @returns {testapis.wktypes.Message} Message
            ...
            Message.decode = function decode(reader, length) {
                ...
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.testapis.wktypes.Message();
            ...
            Message.fromObject = function fromObject(object) {
                if (object instanceof $root.testapis.wktypes.Message)
                    return object;
                var message = new $root.testapis.wktypes.Message();
                if (object.timestamp != null) {
                    if (typeof object.timestamp !== "object")
                        throw TypeError(".testapis.wktypes.Message.timestamp: object expected");
                    message.timestamp = $root.google.protobuf.Timestamp.fromObject(object.timestamp);
                }
                if (object.int32Value != null) {
                    if (typeof object.int32Value !== "object")
                        throw TypeError(".testapis.wktypes.Message.int32Value: object expected");
                ...
                if (object.int64Value != null) {
                    if (typeof object.int64Value !== "object")
                        throw TypeError(".testapis.wktypes.Message.int64Value: object expected");
                ...
                if (object.uint32Value != null) {
                    if (typeof object.uint32Value !== "object")
                        throw TypeError(".testapis.wktypes.Message.uint32Value: object expected");
                ...
                if (object.uint64Value != null) {
                    if (typeof object.uint64Value !== "object")
                        throw TypeError(".testapis.wktypes.Message.uint64Value: object expected");
             ...
             * @memberof testapis.wktypes.Message
             * @static
             * @param {testapis.wktypes.Message} message Message
