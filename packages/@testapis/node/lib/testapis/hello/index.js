...
$root.testapis = (function() {
    ...
    testapis.hello = (function() {
        ...
        hello.Hello = (function() {
             ...
             * @memberof testapis.hello
             * @interface IHello
             * @property {testapis.hello.IPrimitives|null} [requiredPrimitives] Hello requiredPrimitives
             * @property {testapis.hello.IPrimitives|null} [optionalPrimitives] Hello optionalPrimitives
             * @property {Array.<testapis.hello.IPrimitives>|null} [requiredPrimitivesList] Hello requiredPrimitivesList
             * @property {testapis.hello.IPrimitives|null} [optionalPrimitivesList] Hello optionalPrimitivesList
             */
             ...
             * @implements IHello
             * @constructor
             * @param {testapis.hello.IHello=} [properties] Properties to set
             */
             ...
             * @member {testapis.hello.IPrimitives|null|undefined} requiredPrimitives
             * @memberof testapis.hello.Hello
             * @instance
             */
             ...
             * @member {testapis.hello.IPrimitives|null|undefined} optionalPrimitives
             * @memberof testapis.hello.Hello
             * @instance
             */
             ...
             * @member {Array.<testapis.hello.IPrimitives>} requiredPrimitivesList
             * @memberof testapis.hello.Hello
             * @instance
             */
             ...
             * @member {testapis.hello.IPrimitives|null|undefined} optionalPrimitivesList
             * @memberof testapis.hello.Hello
             * @instance
             */
             ...
             * @static
             * @param {testapis.hello.IHello=} [properties] Properties to set
             * @returns {testapis.hello.Hello} Hello instance
             */
             ...
             * @memberof testapis.hello.Hello
             * @static
             * @param {testapis.hello.IHello} message Hello message or plain object to encode
            ...
            Hello.encode = function encode(message, writer) {
                ...
                if (message.requiredPrimitives != null && Object.hasOwnProperty.call(message, "requiredPrimitives"))
                    $root.testapis.hello.Primitives.encode(message.requiredPrimitives, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                if (message.optionalPrimitives != null && Object.hasOwnProperty.call(message, "optionalPrimitives"))
                    $root.testapis.hello.Primitives.encode(message.optionalPrimitives, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                if (message.requiredPrimitivesList != null && message.requiredPrimitivesList.length)
                    for (var i = 0; i < message.requiredPrimitivesList.length; ++i)
                        $root.testapis.hello.Primitives.encode(message.requiredPrimitivesList[i], writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                if (message.optionalPrimitivesList != null && Object.hasOwnProperty.call(message, "optionalPrimitivesList"))
                    $root.testapis.hello.Primitives.encode(message.optionalPrimitivesList, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
                return writer;
            };
             ...
             * @returns {testapis.hello.Hello} Hello
            ...
            Hello.decode = function decode(reader, length) {
                ...
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.testapis.hello.Hello();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
                        message.requiredPrimitives = $root.testapis.hello.Primitives.decode(reader, reader.uint32());
                        break;
                    case 2:
                        message.optionalPrimitives = $root.testapis.hello.Primitives.decode(reader, reader.uint32());
                        break;
                    case 3:
                        if (!(message.requiredPrimitivesList && message.requiredPrimitivesList.length))
                            message.requiredPrimitivesList = [];
                        message.requiredPrimitivesList.push($root.testapis.hello.Primitives.decode(reader, reader.uint32()));
                        break;
                    case 4:
                        message.optionalPrimitivesList = $root.testapis.hello.Primitives.decode(reader, reader.uint32());
                        break;
                    default:
            ...
            Hello.verify = function verify(message) {
                ...
                if (message.requiredPrimitives != null && message.hasOwnProperty("requiredPrimitives")) {
                    var error = $root.testapis.hello.Primitives.verify(message.requiredPrimitives);
                    if (error)
                        return "requiredPrimitives." + error;
                }
                if (message.optionalPrimitives != null && message.hasOwnProperty("optionalPrimitives")) {
                    var error = $root.testapis.hello.Primitives.verify(message.optionalPrimitives);
                    if (error)
                ...
                if (message.requiredPrimitivesList != null && message.hasOwnProperty("requiredPrimitivesList")) {
                    ...
                    for (var i = 0; i < message.requiredPrimitivesList.length; ++i) {
                        var error = $root.testapis.hello.Primitives.verify(message.requiredPrimitivesList[i]);
                        if (error)
                            return "requiredPrimitivesList." + error;
                    }
                }
                if (message.optionalPrimitivesList != null && message.hasOwnProperty("optionalPrimitivesList")) {
                    var error = $root.testapis.hello.Primitives.verify(message.optionalPrimitivesList);
                    if (error)
            ...
            Hello.fromObject = function fromObject(object) {
                if (object instanceof $root.testapis.hello.Hello)
                    return object;
                var message = new $root.testapis.hello.Hello();
                if (object.requiredPrimitives != null) {
                    if (typeof object.requiredPrimitives !== "object")
                        throw TypeError(".testapis.hello.Hello.requiredPrimitives: object expected");
                    message.requiredPrimitives = $root.testapis.hello.Primitives.fromObject(object.requiredPrimitives);
                }
                if (object.optionalPrimitives != null) {
                    if (typeof object.optionalPrimitives !== "object")
                        throw TypeError(".testapis.hello.Hello.optionalPrimitives: object expected");
                    message.optionalPrimitives = $root.testapis.hello.Primitives.fromObject(object.optionalPrimitives);
                }
                if (object.requiredPrimitivesList) {
                    if (!Array.isArray(object.requiredPrimitivesList))
                        throw TypeError(".testapis.hello.Hello.requiredPrimitivesList: array expected");
                    message.requiredPrimitivesList = [];
                    for (var i = 0; i < object.requiredPrimitivesList.length; ++i) {
                        if (typeof object.requiredPrimitivesList[i] !== "object")
                            throw TypeError(".testapis.hello.Hello.requiredPrimitivesList: object expected");
                        message.requiredPrimitivesList[i] = $root.testapis.hello.Primitives.fromObject(object.requiredPrimitivesList[i]);
                    }
                }
                if (object.optionalPrimitivesList != null) {
                    if (typeof object.optionalPrimitivesList !== "object")
                        throw TypeError(".testapis.hello.Hello.optionalPrimitivesList: object expected");
                    message.optionalPrimitivesList = $root.testapis.hello.Primitives.fromObject(object.optionalPrimitivesList);
                }
                return message;
            };
             ...
             * @memberof testapis.hello.Hello
             * @static
             * @param {testapis.hello.Hello} message Hello
            ...
            Hello.toObject = function toObject(message, options) {
                ...
                if (message.requiredPrimitives != null && message.hasOwnProperty("requiredPrimitives"))
                    object.requiredPrimitives = $root.testapis.hello.Primitives.toObject(message.requiredPrimitives, options);
                if (message.optionalPrimitives != null && message.hasOwnProperty("optionalPrimitives"))
                    object.optionalPrimitives = $root.testapis.hello.Primitives.toObject(message.optionalPrimitives, options);
                if (message.requiredPrimitivesList && message.requiredPrimitivesList.length) {
                    object.requiredPrimitivesList = [];
                    for (var j = 0; j < message.requiredPrimitivesList.length; ++j)
                        object.requiredPrimitivesList[j] = $root.testapis.hello.Primitives.toObject(message.requiredPrimitivesList[j], options);
                }
                if (message.optionalPrimitivesList != null && message.hasOwnProperty("optionalPrimitivesList"))
                    object.optionalPrimitivesList = $root.testapis.hello.Primitives.toObject(message.optionalPrimitivesList, options);
                return object;
            };
        ...
        hello.Primitives = (function() {
             ...
             * @constructor
             * @param {testapis.hello.IPrimitives=} [properties] Properties to set
             */
             ...
             * @memberof testapis.hello.Primitives
             * @instance
             */
             ...
             * @static
             * @param {testapis.hello.IPrimitives=} [properties] Properties to set
             * @returns {testapis.hello.Primitives} Primitives instance
             */
             ...
             * @memberof testapis.hello.Primitives
             * @static
             * @param {testapis.hello.IPrimitives} message Primitives message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
             ...
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {testapis.hello.Primitives} Primitives
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            Primitives.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.testapis.hello.Primitives();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            Primitives.fromObject = function fromObject(object) {
                if (object instanceof $root.testapis.hello.Primitives)
                    return object;
                var message = new $root.testapis.hello.Primitives();
             ...
             * @memberof testapis.hello.Primitives
             * @static
             * @param {testapis.hello.Primitives} message Primitives
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
