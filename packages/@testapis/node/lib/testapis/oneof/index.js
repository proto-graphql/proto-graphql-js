...
$root.testapis = (function() {
    ...
    testapis.oneof = (function() {
        ...
        oneof.OneofParent = (function() {
             ...
             * @memberof testapis.oneof
             * @interface IOneofParent
             * @property {string|null} [normalField] OneofParent normalField
             * @property {testapis.oneof.IOneofMemberMessage1|null} [requiredMessage1] OneofParent requiredMessage1
             * @property {testapis.oneof.IOneofMemberMessage2|null} [requiredMessage2] OneofParent requiredMessage2
             * @property {testapis.oneof.IOneofMemberMessage1|null} [optoinalMessage1] OneofParent optoinalMessage1
             * @property {testapis.oneof.IOneofMemberMessage2|null} [optoinalMessage2] OneofParent optoinalMessage2
             */
             ...
             * @constructor
             * @param {testapis.oneof.IOneofParent=} [properties] Properties to set
             */
             ...
             * @memberof testapis.oneof.OneofParent
             * @instance
             */
             ...
             * @member {testapis.oneof.IOneofMemberMessage1|null|undefined} requiredMessage1
             * @memberof testapis.oneof.OneofParent
             * @instance
             */
             ...
             * @member {testapis.oneof.IOneofMemberMessage2|null|undefined} requiredMessage2
             * @memberof testapis.oneof.OneofParent
             * @instance
             */
             ...
             * @member {testapis.oneof.IOneofMemberMessage1|null|undefined} optoinalMessage1
             * @memberof testapis.oneof.OneofParent
             * @instance
             */
             ...
             * @member {testapis.oneof.IOneofMemberMessage2|null|undefined} optoinalMessage2
             * @memberof testapis.oneof.OneofParent
             * @instance
             */
             ...
             * @static
             * @param {testapis.oneof.IOneofParent=} [properties] Properties to set
             * @returns {testapis.oneof.OneofParent} OneofParent instance
             */
            ...
            /**
             * Encodes the specified OneofParent message. Does not implicitly {@link testapis.oneof.OneofParent.verify|verify} messages.
             * @function encode
             * @memberof testapis.oneof.OneofParent
             * @static
             * @param {testapis.oneof.IOneofParent} message OneofParent message or plain object to encode
            ...
            OneofParent.encode = function encode(message, writer) {
                ...
                if (message.requiredMessage1 != null && Object.hasOwnProperty.call(message, "requiredMessage1"))
                    $root.testapis.oneof.OneofMemberMessage1.encode(message.requiredMessage1, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                if (message.requiredMessage2 != null && Object.hasOwnProperty.call(message, "requiredMessage2"))
                    $root.testapis.oneof.OneofMemberMessage2.encode(message.requiredMessage2, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                if (message.optoinalMessage1 != null && Object.hasOwnProperty.call(message, "optoinalMessage1"))
                    $root.testapis.oneof.OneofMemberMessage1.encode(message.optoinalMessage1, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
                if (message.optoinalMessage2 != null && Object.hasOwnProperty.call(message, "optoinalMessage2"))
                    $root.testapis.oneof.OneofMemberMessage2.encode(message.optoinalMessage2, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
                return writer;
            };

            /**
             * Encodes the specified OneofParent message, length delimited. Does not implicitly {@link testapis.oneof.OneofParent.verify|verify} messages.
             ...
             * @returns {testapis.oneof.OneofParent} OneofParent
            ...
            OneofParent.decode = function decode(reader, length) {
                ...
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.testapis.oneof.OneofParent();
                while (reader.pos < end) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        message.requiredMessage1 = $root.testapis.oneof.OneofMemberMessage1.decode(reader, reader.uint32());
                        break;
                    case 3:
                        message.requiredMessage2 = $root.testapis.oneof.OneofMemberMessage2.decode(reader, reader.uint32());
                        break;
                    case 4:
                        message.optoinalMessage1 = $root.testapis.oneof.OneofMemberMessage1.decode(reader, reader.uint32());
                        break;
                    case 5:
                        message.optoinalMessage2 = $root.testapis.oneof.OneofMemberMessage2.decode(reader, reader.uint32());
                        break;
                    default:
            ...
            OneofParent.verify = function verify(message) {
                ...
                if (message.requiredMessage1 != null && message.hasOwnProperty("requiredMessage1")) {
                    ...
                    {
                        var error = $root.testapis.oneof.OneofMemberMessage1.verify(message.requiredMessage1);
                        if (error)
                ...
                if (message.requiredMessage2 != null && message.hasOwnProperty("requiredMessage2")) {
                    ...
                    properties.requiredOneofMembers = 1;
                    {
                        var error = $root.testapis.oneof.OneofMemberMessage2.verify(message.requiredMessage2);
                        if (error)
                ...
                if (message.optoinalMessage1 != null && message.hasOwnProperty("optoinalMessage1")) {
                    ...
                    {
                        var error = $root.testapis.oneof.OneofMemberMessage1.verify(message.optoinalMessage1);
                        if (error)
                ...
                if (message.optoinalMessage2 != null && message.hasOwnProperty("optoinalMessage2")) {
                    ...
                    properties.optionalOneofMembers = 1;
                    {
                        var error = $root.testapis.oneof.OneofMemberMessage2.verify(message.optoinalMessage2);
                        if (error)
            ...
            OneofParent.fromObject = function fromObject(object) {
                if (object instanceof $root.testapis.oneof.OneofParent)
                    return object;
                var message = new $root.testapis.oneof.OneofParent();
                ...
                if (object.requiredMessage1 != null) {
                    if (typeof object.requiredMessage1 !== "object")
                        throw TypeError(".testapis.oneof.OneofParent.requiredMessage1: object expected");
                    message.requiredMessage1 = $root.testapis.oneof.OneofMemberMessage1.fromObject(object.requiredMessage1);
                }
                if (object.requiredMessage2 != null) {
                    if (typeof object.requiredMessage2 !== "object")
                        throw TypeError(".testapis.oneof.OneofParent.requiredMessage2: object expected");
                    message.requiredMessage2 = $root.testapis.oneof.OneofMemberMessage2.fromObject(object.requiredMessage2);
                }
                if (object.optoinalMessage1 != null) {
                    if (typeof object.optoinalMessage1 !== "object")
                        throw TypeError(".testapis.oneof.OneofParent.optoinalMessage1: object expected");
                    message.optoinalMessage1 = $root.testapis.oneof.OneofMemberMessage1.fromObject(object.optoinalMessage1);
                }
                if (object.optoinalMessage2 != null) {
                    if (typeof object.optoinalMessage2 !== "object")
                        throw TypeError(".testapis.oneof.OneofParent.optoinalMessage2: object expected");
                    message.optoinalMessage2 = $root.testapis.oneof.OneofMemberMessage2.fromObject(object.optoinalMessage2);
                }
                return message;
            };
             ...
             * @memberof testapis.oneof.OneofParent
             * @static
             * @param {testapis.oneof.OneofParent} message OneofParent
            ...
            OneofParent.toObject = function toObject(message, options) {
                ...
                if (message.requiredMessage1 != null && message.hasOwnProperty("requiredMessage1")) {
                    object.requiredMessage1 = $root.testapis.oneof.OneofMemberMessage1.toObject(message.requiredMessage1, options);
                    if (options.oneofs)
                        object.requiredOneofMembers = "requiredMessage1";
                }
                if (message.requiredMessage2 != null && message.hasOwnProperty("requiredMessage2")) {
                    object.requiredMessage2 = $root.testapis.oneof.OneofMemberMessage2.toObject(message.requiredMessage2, options);
                    if (options.oneofs)
                        object.requiredOneofMembers = "requiredMessage2";
                }
                if (message.optoinalMessage1 != null && message.hasOwnProperty("optoinalMessage1")) {
                    object.optoinalMessage1 = $root.testapis.oneof.OneofMemberMessage1.toObject(message.optoinalMessage1, options);
                    if (options.oneofs)
                        object.optionalOneofMembers = "optoinalMessage1";
                }
                if (message.optoinalMessage2 != null && message.hasOwnProperty("optoinalMessage2")) {
                    object.optoinalMessage2 = $root.testapis.oneof.OneofMemberMessage2.toObject(message.optoinalMessage2, options);
                    if (options.oneofs)
        ...
        oneof.OneofMemberMessage1 = (function() {
             ...
             * @constructor
             * @param {testapis.oneof.IOneofMemberMessage1=} [properties] Properties to set
             */
             ...
             * @member {string} body
             * @memberof testapis.oneof.OneofMemberMessage1
             * @instance
             */
             ...
             * @static
             * @param {testapis.oneof.IOneofMemberMessage1=} [properties] Properties to set
             * @returns {testapis.oneof.OneofMemberMessage1} OneofMemberMessage1 instance
             */
            ...
            /**
             * Encodes the specified OneofMemberMessage1 message. Does not implicitly {@link testapis.oneof.OneofMemberMessage1.verify|verify} messages.
             * @function encode
             * @memberof testapis.oneof.OneofMemberMessage1
             * @static
             * @param {testapis.oneof.IOneofMemberMessage1} message OneofMemberMessage1 message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            ...
            /**
             * Encodes the specified OneofMemberMessage1 message, length delimited. Does not implicitly {@link testapis.oneof.OneofMemberMessage1.verify|verify} messages.
             * @function encodeDelimited
             * @memberof testapis.oneof.OneofMemberMessage1
             * @static
             * @param {testapis.oneof.IOneofMemberMessage1} message OneofMemberMessage1 message or plain object to encode
             ...
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {testapis.oneof.OneofMemberMessage1} OneofMemberMessage1
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            OneofMemberMessage1.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.testapis.oneof.OneofMemberMessage1();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            OneofMemberMessage1.fromObject = function fromObject(object) {
                if (object instanceof $root.testapis.oneof.OneofMemberMessage1)
                    return object;
                var message = new $root.testapis.oneof.OneofMemberMessage1();
                if (object.body != null)
             ...
             * @memberof testapis.oneof.OneofMemberMessage1
             * @static
             * @param {testapis.oneof.OneofMemberMessage1} message OneofMemberMessage1
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
        ...
        oneof.OneofMemberMessage2 = (function() {
             ...
             * @constructor
             * @param {testapis.oneof.IOneofMemberMessage2=} [properties] Properties to set
             */
             ...
             * @memberof testapis.oneof.OneofMemberMessage2
             * @instance
             */
             ...
             * @static
             * @param {testapis.oneof.IOneofMemberMessage2=} [properties] Properties to set
             * @returns {testapis.oneof.OneofMemberMessage2} OneofMemberMessage2 instance
             */
            ...
            /**
             * Encodes the specified OneofMemberMessage2 message. Does not implicitly {@link testapis.oneof.OneofMemberMessage2.verify|verify} messages.
             * @function encode
             * @memberof testapis.oneof.OneofMemberMessage2
             * @static
             * @param {testapis.oneof.IOneofMemberMessage2} message OneofMemberMessage2 message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            ...
            /**
             * Encodes the specified OneofMemberMessage2 message, length delimited. Does not implicitly {@link testapis.oneof.OneofMemberMessage2.verify|verify} messages.
             * @function encodeDelimited
             * @memberof testapis.oneof.OneofMemberMessage2
             * @static
             * @param {testapis.oneof.IOneofMemberMessage2} message OneofMemberMessage2 message or plain object to encode
             ...
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {testapis.oneof.OneofMemberMessage2} OneofMemberMessage2
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            OneofMemberMessage2.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.testapis.oneof.OneofMemberMessage2();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            OneofMemberMessage2.fromObject = function fromObject(object) {
                if (object instanceof $root.testapis.oneof.OneofMemberMessage2)
                    return object;
                var message = new $root.testapis.oneof.OneofMemberMessage2();
             ...
             * @memberof testapis.oneof.OneofMemberMessage2
             * @static
             * @param {testapis.oneof.OneofMemberMessage2} message OneofMemberMessage2
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
