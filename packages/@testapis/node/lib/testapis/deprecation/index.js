...
$root.testapis = (function() {
    ...
    testapis.deprecation = (function() {
        ...
        deprecation.DeprecatedMessage = (function() {
             ...
             * @memberof testapis.deprecation
             * @interface IDeprecatedMessage
             * @property {string|null} [body] DeprecatedMessage body
             * @property {testapis.deprecation.NotDeprecatedEnum|null} ["enum"] DeprecatedMessage enum
             */
             ...
             * @constructor
             * @param {testapis.deprecation.IDeprecatedMessage=} [properties] Properties to set
             */
             ...
             * @member {string} body
             * @memberof testapis.deprecation.DeprecatedMessage
             * @instance
             */
             ...
             * @member {testapis.deprecation.NotDeprecatedEnum} enum
             * @memberof testapis.deprecation.DeprecatedMessage
             * @instance
             */
             ...
             * @static
             * @param {testapis.deprecation.IDeprecatedMessage=} [properties] Properties to set
             * @returns {testapis.deprecation.DeprecatedMessage} DeprecatedMessage instance
             */
             ...
             * @memberof testapis.deprecation.DeprecatedMessage
             * @static
             * @param {testapis.deprecation.IDeprecatedMessage} message DeprecatedMessage message or plain object to encode
             ...
             * @returns {testapis.deprecation.DeprecatedMessage} DeprecatedMessage
            ...
            DeprecatedMessage.decode = function decode(reader, length) {
                ...
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.testapis.deprecation.DeprecatedMessage();
            ...
            DeprecatedMessage.fromObject = function fromObject(object) {
                if (object instanceof $root.testapis.deprecation.DeprecatedMessage)
                    return object;
                var message = new $root.testapis.deprecation.DeprecatedMessage();
                if (object.body != null)
             ...
             * @memberof testapis.deprecation.DeprecatedMessage
             * @static
             * @param {testapis.deprecation.DeprecatedMessage} message DeprecatedMessage
            ...
            DeprecatedMessage.toObject = function toObject(message, options) {
                ...
                if (message["enum"] != null && message.hasOwnProperty("enum"))
                    object["enum"] = options.enums === String ? $root.testapis.deprecation.NotDeprecatedEnum[message["enum"]] : message["enum"];
                return object;
            };
            ...
            DeprecatedMessage.InnerMessage = (function() {
                 ...
                 * @constructor
                 * @param {testapis.deprecation.DeprecatedMessage.IInnerMessage=} [properties] Properties to set
                 */
                 ...
                 * InnerMessage body.
                 * @member {string} body
                 * @memberof testapis.deprecation.DeprecatedMessage.InnerMessage
                 * @instance
                 */
                 ...
                 * @static
                 * @param {testapis.deprecation.DeprecatedMessage.IInnerMessage=} [properties] Properties to set
                 * @returns {testapis.deprecation.DeprecatedMessage.InnerMessage} InnerMessage instance
                 */
                 ...
                 * @memberof testapis.deprecation.DeprecatedMessage.InnerMessage
                 * @static
                 * @param {testapis.deprecation.DeprecatedMessage.IInnerMessage} message InnerMessage message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
                 ...
                 * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                 * @param {number} [length] Message length if known beforehand
                 * @returns {testapis.deprecation.DeprecatedMessage.InnerMessage} InnerMessage
                 * @throws {Error} If the payload is not a reader or valid buffer
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                InnerMessage.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.testapis.deprecation.DeprecatedMessage.InnerMessage();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1:
                ...
                InnerMessage.fromObject = function fromObject(object) {
                    if (object instanceof $root.testapis.deprecation.DeprecatedMessage.InnerMessage)
                        return object;
                    var message = new $root.testapis.deprecation.DeprecatedMessage.InnerMessage();
                    if (object.body != null)
                        message.body = String(object.body);
                    return message;
                };
                 ...
                 * @memberof testapis.deprecation.DeprecatedMessage.InnerMessage
                 * @static
                 * @param {testapis.deprecation.DeprecatedMessage.InnerMessage} message InnerMessage
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
        ...
        deprecation.NotDeprecatedMessage = (function() {
             ...
             * @property {testapis.deprecation.DeprecatedEnum|null} ["enum"] NotDeprecatedMessage enum
             * @property {testapis.deprecation.NotDeprecatedMessage.IInnerMessage1|null} [msg1] NotDeprecatedMessage msg1
             * @property {testapis.deprecation.NotDeprecatedMessage.IInnerMessage2|null} [msg2] NotDeprecatedMessage msg2
             * @property {testapis.deprecation.NotDeprecatedMessage.IInnerMessage1|null} [msg3] NotDeprecatedMessage msg3
             * @property {testapis.deprecation.NotDeprecatedMessage.IInnerMessage2|null} [msg4] NotDeprecatedMessage msg4
             */
             ...
             * @constructor
             * @param {testapis.deprecation.INotDeprecatedMessage=} [properties] Properties to set
             */
             ...
             * @member {string} body
             * @memberof testapis.deprecation.NotDeprecatedMessage
             * @instance
             */
             ...
             * @member {testapis.deprecation.DeprecatedEnum} enum
             * @memberof testapis.deprecation.NotDeprecatedMessage
             * @instance
             */
             ...
             * @member {testapis.deprecation.NotDeprecatedMessage.IInnerMessage1|null|undefined} msg1
             * @memberof testapis.deprecation.NotDeprecatedMessage
             * @instance
             */
             ...
             * @member {testapis.deprecation.NotDeprecatedMessage.IInnerMessage2|null|undefined} msg2
             * @memberof testapis.deprecation.NotDeprecatedMessage
             * @instance
             */
             ...
             * @member {testapis.deprecation.NotDeprecatedMessage.IInnerMessage1|null|undefined} msg3
             * @memberof testapis.deprecation.NotDeprecatedMessage
             * @instance
             */
             ...
             * @member {testapis.deprecation.NotDeprecatedMessage.IInnerMessage2|null|undefined} msg4
             * @memberof testapis.deprecation.NotDeprecatedMessage
             * @instance
             */
             ...
             * @static
             * @param {testapis.deprecation.INotDeprecatedMessage=} [properties] Properties to set
             * @returns {testapis.deprecation.NotDeprecatedMessage} NotDeprecatedMessage instance
             */
             ...
             * @memberof testapis.deprecation.NotDeprecatedMessage
             * @static
             * @param {testapis.deprecation.INotDeprecatedMessage} message NotDeprecatedMessage message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            NotDeprecatedMessage.encode = function encode(message, writer) {
                ...
                if (message.msg1 != null && Object.hasOwnProperty.call(message, "msg1"))
                    $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage1.encode(message.msg1, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                if (message.msg2 != null && Object.hasOwnProperty.call(message, "msg2"))
                    $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage2.encode(message.msg2, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
                if (message.msg3 != null && Object.hasOwnProperty.call(message, "msg3"))
                    $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage1.encode(message.msg3, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
                if (message.msg4 != null && Object.hasOwnProperty.call(message, "msg4"))
                    $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage2.encode(message.msg4, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
                return writer;
            };
             ...
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {testapis.deprecation.NotDeprecatedMessage} NotDeprecatedMessage
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            NotDeprecatedMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.testapis.deprecation.NotDeprecatedMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        message.msg1 = $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage1.decode(reader, reader.uint32());
                        break;
                    case 4:
                        message.msg2 = $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage2.decode(reader, reader.uint32());
                        break;
                    case 5:
                        message.msg3 = $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage1.decode(reader, reader.uint32());
                        break;
                    case 6:
                        message.msg4 = $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage2.decode(reader, reader.uint32());
                        break;
                    default:
                        reader.skipType(tag & 7);
                        break;
            ...
            NotDeprecatedMessage.verify = function verify(message) {
                ...
                if (message.msg1 != null && message.hasOwnProperty("msg1")) {
                    ...
                    {
                        var error = $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage1.verify(message.msg1);
                        if (error)
                            return "msg1." + error;
                    }
                }
                if (message.msg2 != null && message.hasOwnProperty("msg2")) {
                    ...
                    properties.notDeprecatedOneof = 1;
                    {
                        var error = $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage2.verify(message.msg2);
                        if (error)
                            return "msg2." + error;
                    }
                }
                if (message.msg3 != null && message.hasOwnProperty("msg3")) {
                    ...
                    {
                        var error = $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage1.verify(message.msg3);
                        if (error)
                            return "msg3." + error;
                    }
                }
                if (message.msg4 != null && message.hasOwnProperty("msg4")) {
                    ...
                    properties.deprecatedOneof = 1;
                    {
                        var error = $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage2.verify(message.msg4);
                        if (error)
                            return "msg4." + error;
                    }
                }
            ...
            NotDeprecatedMessage.fromObject = function fromObject(object) {
                if (object instanceof $root.testapis.deprecation.NotDeprecatedMessage)
                    return object;
                var message = new $root.testapis.deprecation.NotDeprecatedMessage();
                if (object.body != null)
                    message.body = String(object.body);
                switch (object["enum"]) {
                ...
                if (object.msg1 != null) {
                    if (typeof object.msg1 !== "object")
                        throw TypeError(".testapis.deprecation.NotDeprecatedMessage.msg1: object expected");
                    message.msg1 = $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage1.fromObject(object.msg1);
                }
                if (object.msg2 != null) {
                    if (typeof object.msg2 !== "object")
                        throw TypeError(".testapis.deprecation.NotDeprecatedMessage.msg2: object expected");
                    message.msg2 = $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage2.fromObject(object.msg2);
                }
                if (object.msg3 != null) {
                    if (typeof object.msg3 !== "object")
                        throw TypeError(".testapis.deprecation.NotDeprecatedMessage.msg3: object expected");
                    message.msg3 = $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage1.fromObject(object.msg3);
                }
                if (object.msg4 != null) {
                    if (typeof object.msg4 !== "object")
                        throw TypeError(".testapis.deprecation.NotDeprecatedMessage.msg4: object expected");
                    message.msg4 = $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage2.fromObject(object.msg4);
                }
                return message;
            };
             ...
             * @memberof testapis.deprecation.NotDeprecatedMessage
             * @static
             * @param {testapis.deprecation.NotDeprecatedMessage} message NotDeprecatedMessage
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            NotDeprecatedMessage.toObject = function toObject(message, options) {
                ...
                if (message.body != null && message.hasOwnProperty("body"))
                    object.body = message.body;
                if (message["enum"] != null && message.hasOwnProperty("enum"))
                    object["enum"] = options.enums === String ? $root.testapis.deprecation.DeprecatedEnum[message["enum"]] : message["enum"];
                if (message.msg1 != null && message.hasOwnProperty("msg1")) {
                    object.msg1 = $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage1.toObject(message.msg1, options);
                    if (options.oneofs)
                        object.notDeprecatedOneof = "msg1";
                }
                if (message.msg2 != null && message.hasOwnProperty("msg2")) {
                    object.msg2 = $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage2.toObject(message.msg2, options);
                    if (options.oneofs)
                        object.notDeprecatedOneof = "msg2";
                }
                if (message.msg3 != null && message.hasOwnProperty("msg3")) {
                    object.msg3 = $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage1.toObject(message.msg3, options);
                    if (options.oneofs)
                        object.deprecatedOneof = "msg3";
                }
                if (message.msg4 != null && message.hasOwnProperty("msg4")) {
                    object.msg4 = $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage2.toObject(message.msg4, options);
                    if (options.oneofs)
            ...
            NotDeprecatedMessage.InnerMessage1 = (function() {
                 ...
                 * @constructor
                 * @param {testapis.deprecation.NotDeprecatedMessage.IInnerMessage1=} [properties] Properties to set
                 */
                 ...
                 * InnerMessage1 body.
                 * @member {string} body
                 * @memberof testapis.deprecation.NotDeprecatedMessage.InnerMessage1
                 * @instance
                 */
                 ...
                 * @static
                 * @param {testapis.deprecation.NotDeprecatedMessage.IInnerMessage1=} [properties] Properties to set
                 * @returns {testapis.deprecation.NotDeprecatedMessage.InnerMessage1} InnerMessage1 instance
                 */
                 ...
                 * @memberof testapis.deprecation.NotDeprecatedMessage.InnerMessage1
                 * @static
                 * @param {testapis.deprecation.NotDeprecatedMessage.IInnerMessage1} message InnerMessage1 message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
                 ...
                 * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                 * @param {number} [length] Message length if known beforehand
                 * @returns {testapis.deprecation.NotDeprecatedMessage.InnerMessage1} InnerMessage1
                 * @throws {Error} If the payload is not a reader or valid buffer
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                InnerMessage1.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage1();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1:
                ...
                InnerMessage1.fromObject = function fromObject(object) {
                    if (object instanceof $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage1)
                        return object;
                    var message = new $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage1();
                    if (object.body != null)
                        message.body = String(object.body);
                    return message;
                };
                 ...
                 * @memberof testapis.deprecation.NotDeprecatedMessage.InnerMessage1
                 * @static
                 * @param {testapis.deprecation.NotDeprecatedMessage.InnerMessage1} message InnerMessage1
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            NotDeprecatedMessage.InnerMessage2 = (function() {
                 ...
                 * @constructor
                 * @param {testapis.deprecation.NotDeprecatedMessage.IInnerMessage2=} [properties] Properties to set
                 */
                 ...
                 * InnerMessage2 body.
                 * @member {string} body
                 * @memberof testapis.deprecation.NotDeprecatedMessage.InnerMessage2
                 * @instance
                 */
                 ...
                 * @static
                 * @param {testapis.deprecation.NotDeprecatedMessage.IInnerMessage2=} [properties] Properties to set
                 * @returns {testapis.deprecation.NotDeprecatedMessage.InnerMessage2} InnerMessage2 instance
                 */
                 ...
                 * @memberof testapis.deprecation.NotDeprecatedMessage.InnerMessage2
                 * @static
                 * @param {testapis.deprecation.NotDeprecatedMessage.IInnerMessage2} message InnerMessage2 message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
                 ...
                 * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                 * @param {number} [length] Message length if known beforehand
                 * @returns {testapis.deprecation.NotDeprecatedMessage.InnerMessage2} InnerMessage2
                 * @throws {Error} If the payload is not a reader or valid buffer
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                InnerMessage2.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage2();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1:
                ...
                InnerMessage2.fromObject = function fromObject(object) {
                    if (object instanceof $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage2)
                        return object;
                    var message = new $root.testapis.deprecation.NotDeprecatedMessage.InnerMessage2();
                    if (object.body != null)
                        message.body = String(object.body);
                    return message;
                };
                 ...
                 * @memberof testapis.deprecation.NotDeprecatedMessage.InnerMessage2
                 * @static
                 * @param {testapis.deprecation.NotDeprecatedMessage.InnerMessage2} message InnerMessage2
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
         ...
         * @name testapis.deprecation.NotDeprecatedEnum
         * @enum {number}
        ...
        /**
         * DeprecatedEnum enum.
         * @name testapis.deprecation.DeprecatedEnum
         * @enum {number}
        ...
        deprecation.DeprecatedFileMessage = (function() {
             ...
             * @property {testapis.deprecation.DeprecatedFileEnum|null} ["enum"] DeprecatedFileMessage enum
             */
             ...
             * @constructor
             * @param {testapis.deprecation.IDeprecatedFileMessage=} [properties] Properties to set
             */
             ...
             * @member {string} body
             * @memberof testapis.deprecation.DeprecatedFileMessage
             * @instance
             */
             ...
             * @member {testapis.deprecation.DeprecatedFileEnum} enum
             * @memberof testapis.deprecation.DeprecatedFileMessage
             * @instance
             */
             ...
             * @static
             * @param {testapis.deprecation.IDeprecatedFileMessage=} [properties] Properties to set
             * @returns {testapis.deprecation.DeprecatedFileMessage} DeprecatedFileMessage instance
             */
             ...
             * @memberof testapis.deprecation.DeprecatedFileMessage
             * @static
             * @param {testapis.deprecation.IDeprecatedFileMessage} message DeprecatedFileMessage message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
             ...
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {testapis.deprecation.DeprecatedFileMessage} DeprecatedFileMessage
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            DeprecatedFileMessage.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.testapis.deprecation.DeprecatedFileMessage();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            DeprecatedFileMessage.fromObject = function fromObject(object) {
                if (object instanceof $root.testapis.deprecation.DeprecatedFileMessage)
                    return object;
                var message = new $root.testapis.deprecation.DeprecatedFileMessage();
                if (object.body != null)
                    message.body = String(object.body);
                switch (object["enum"]) {
             ...
             * @memberof testapis.deprecation.DeprecatedFileMessage
             * @static
             * @param {testapis.deprecation.DeprecatedFileMessage} message DeprecatedFileMessage
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            DeprecatedFileMessage.toObject = function toObject(message, options) {
                ...
                if (message.body != null && message.hasOwnProperty("body"))
                    object.body = message.body;
                if (message["enum"] != null && message.hasOwnProperty("enum"))
                    object["enum"] = options.enums === String ? $root.testapis.deprecation.DeprecatedFileEnum[message["enum"]] : message["enum"];
                return object;
            };
            ...
            DeprecatedFileMessage.InnerMessage = (function() {
                 ...
                 * @implements IInnerMessage
                 * @constructor
                 * @param {testapis.deprecation.DeprecatedFileMessage.IInnerMessage=} [properties] Properties to set
                 */
                function InnerMessage(properties) {
                    if (properties)
                        for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                 ...
                 * InnerMessage body.
                 * @member {string} body
                 * @memberof testapis.deprecation.DeprecatedFileMessage.InnerMessage
                 * @instance
                 */
                InnerMessage.prototype.body = "";
                 ...
                 * @static
                 * @param {testapis.deprecation.DeprecatedFileMessage.IInnerMessage=} [properties] Properties to set
                 * @returns {testapis.deprecation.DeprecatedFileMessage.InnerMessage} InnerMessage instance
                 */
                InnerMessage.create = function create(properties) {
                    return new InnerMessage(properties);
                };
                 ...
                 * @memberof testapis.deprecation.DeprecatedFileMessage.InnerMessage
                 * @static
                 * @param {testapis.deprecation.DeprecatedFileMessage.IInnerMessage} message InnerMessage message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
                InnerMessage.encode = function encode(message, writer) {
                 ...
                 * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                 * @param {number} [length] Message length if known beforehand
                 * @returns {testapis.deprecation.DeprecatedFileMessage.InnerMessage} InnerMessage
                 * @throws {Error} If the payload is not a reader or valid buffer
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                InnerMessage.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.testapis.deprecation.DeprecatedFileMessage.InnerMessage();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1:
                 ...
                 */
                InnerMessage.fromObject = function fromObject(object) {
                    if (object instanceof $root.testapis.deprecation.DeprecatedFileMessage.InnerMessage)
                        return object;
                    var message = new $root.testapis.deprecation.DeprecatedFileMessage.InnerMessage();
                    if (object.body != null)
                        message.body = String(object.body);
                    return message;
                };
                 ...
                 * @memberof testapis.deprecation.DeprecatedFileMessage.InnerMessage
                 * @static
                 * @param {testapis.deprecation.DeprecatedFileMessage.InnerMessage} message InnerMessage
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                InnerMessage.toObject = function toObject(message, options) {
         ...
         * @name testapis.deprecation.DeprecatedFileEnum
         * @enum {number}
