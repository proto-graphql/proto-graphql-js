...
$root.testapi = (function() {
    ...
    testapi.nested = (function() {
        ...
        nested.ParentMessage = (function() {
             ...
             * @property {testapi.nested.ParentMessage.INestedMessage|null} [nested] ParentMessage nested
             * @property {testapi.nested.ParentMessage.NestedEnum|null} [nestedEnum] ParentMessage nestedEnum
             */
             ...
             * @constructor
             * @param {testapi.nested.IParentMessage=} [properties] Properties to set
             */
             ...
             * ParentMessage body.
             * @member {string} body
             * @memberof testapi.nested.ParentMessage
             * @instance
             */
             ...
             * @member {testapi.nested.ParentMessage.INestedMessage|null|undefined} nested
             * @memberof testapi.nested.ParentMessage
             * @instance
             */
             ...
             * @member {testapi.nested.ParentMessage.NestedEnum} nestedEnum
             * @memberof testapi.nested.ParentMessage
             * @instance
             */
             ...
             * @static
             * @param {testapi.nested.IParentMessage=} [properties] Properties to set
             * @returns {testapi.nested.ParentMessage} ParentMessage instance
             */
             ...
             * @memberof testapi.nested.ParentMessage
             * @static
             * @param {testapi.nested.IParentMessage} message ParentMessage message or plain object to encode
            ...
            ParentMessage.encode = function encode(message, writer) {
                ...
                if (message.nested != null && Object.hasOwnProperty.call(message, "nested"))
                    $root.testapi.nested.ParentMessage.NestedMessage.encode(message.nested, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
             ...
             * @returns {testapi.nested.ParentMessage} ParentMessage
            ...
            ParentMessage.decode = function decode(reader, length) {
                ...
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.testapi.nested.ParentMessage();
                while (reader.pos < end) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        message.nested = $root.testapi.nested.ParentMessage.NestedMessage.decode(reader, reader.uint32());
                        break;
                    case 3:
            ...
            ParentMessage.verify = function verify(message) {
                ...
                if (message.nested != null && message.hasOwnProperty("nested")) {
                    var error = $root.testapi.nested.ParentMessage.NestedMessage.verify(message.nested);
                    if (error)
                        return "nested." + error;
                }
            ...
            ParentMessage.fromObject = function fromObject(object) {
                if (object instanceof $root.testapi.nested.ParentMessage)
                    return object;
                var message = new $root.testapi.nested.ParentMessage();
                if (object.body != null)
                    message.body = String(object.body);
                if (object.nested != null) {
                    if (typeof object.nested !== "object")
                        throw TypeError(".testapi.nested.ParentMessage.nested: object expected");
                    message.nested = $root.testapi.nested.ParentMessage.NestedMessage.fromObject(object.nested);
                }
             ...
             * @memberof testapi.nested.ParentMessage
             * @static
             * @param {testapi.nested.ParentMessage} message ParentMessage
            ...
            ParentMessage.toObject = function toObject(message, options) {
                ...
                if (message.nested != null && message.hasOwnProperty("nested"))
                    object.nested = $root.testapi.nested.ParentMessage.NestedMessage.toObject(message.nested, options);
                if (message.nestedEnum != null && message.hasOwnProperty("nestedEnum"))
                    object.nestedEnum = options.enums === String ? $root.testapi.nested.ParentMessage.NestedEnum[message.nestedEnum] : message.nestedEnum;
                return object;
            };
            ...
            ParentMessage.NestedMessage = (function() {
                 ...
                 * @constructor
                 * @param {testapi.nested.ParentMessage.INestedMessage=} [properties] Properties to set
                 */
                 ...
                 * @memberof testapi.nested.ParentMessage.NestedMessage
                 * @instance
                 */
                 ...
                 * @static
                 * @param {testapi.nested.ParentMessage.INestedMessage=} [properties] Properties to set
                 * @returns {testapi.nested.ParentMessage.NestedMessage} NestedMessage instance
                 */
                 ...
                 * @memberof testapi.nested.ParentMessage.NestedMessage
                 * @static
                 * @param {testapi.nested.ParentMessage.INestedMessage} message NestedMessage message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
                 ...
                 * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                 * @param {number} [length] Message length if known beforehand
                 * @returns {testapi.nested.ParentMessage.NestedMessage} NestedMessage
                 * @throws {Error} If the payload is not a reader or valid buffer
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                NestedMessage.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.testapi.nested.ParentMessage.NestedMessage();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1:
                ...
                NestedMessage.fromObject = function fromObject(object) {
                    if (object instanceof $root.testapi.nested.ParentMessage.NestedMessage)
                        return object;
                    var message = new $root.testapi.nested.ParentMessage.NestedMessage();
                 ...
                 * @memberof testapi.nested.ParentMessage.NestedMessage
                 * @static
                 * @param {testapi.nested.ParentMessage.NestedMessage} message NestedMessage
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            /**
             * NestedEnum enum.
             * @name testapi.nested.ParentMessage.NestedEnum
             * @enum {number}
